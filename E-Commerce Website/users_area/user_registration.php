...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="mt-4 pt-2">
        <input type="submit" value="Register" class="btn btn-danger px-3 py-2 text-light border-0" name="user_register">
    </div>
    <p class="small fw-bold mt-2 pt-1 mb-0">Already have an account ? <a href="user_login.php" class="text-danger">Login</p></a>
