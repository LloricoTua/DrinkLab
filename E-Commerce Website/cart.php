...
if(isset($_POST['update_cart'])){
  ...
  $total_price=$total_price*$quantities;
                    ...
                    <td>
                        <!-- <button class="btn btn-secondary px-3 py-2 text-light border-0 mx-3">Update</button> -->
                        <input type="submit" value="Update Cart" class="btn btn-secondary px-3 py-2 text-light border-0 mx-3" name="update_cart">
                        <!-- <button class="btn btn-danger px-3 py-2 text-light border-0 mx-3">Remove</button> -->
